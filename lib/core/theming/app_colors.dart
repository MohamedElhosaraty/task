...
class AppColors {
  ...
  // to app
  static const Color primary = Color(0xFF2F6F6B); // dark teal
  static const Color primaryLight = Color(0xFF5FA39B); // light teal (gradient end)
  static const Color fieldFill = Color(0xFFF4F6F6);
  static const Color textPrimary = Color(0xFF1E2B2A);
  static const Color textSecondary = Color(0xFF8A9A98);
  static const Color hint = Color(0xFFB8C4C2);
  ...
  static const Color secondaryLight = Color(0xFFADADAC);
  static const Color background2 = Color(0xFFF4F7F6);
  static const Color primaryColor = Color(0xFF2C6062);
